...
exports.main = function(pm, options) {
    ...
    if (pm.context.package && !options.pm) {
        throw new Error("If 'context.package' is set, 'options.pm' should be set as well!");
    }
                        ...
                        return PM.forPackagePath(pkgInfo[0].path, pm).then(function(pm) {
                            ...
                            return pm.path(args).then(function(path) {
                                ...
                                function install() {
                                    ...
                                    Q.when(pm[(options.update === true)?"update":"install"](args), function() {
