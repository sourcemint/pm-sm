...
var PM = function() {
    ...
    this.context.credentials = new CREDENTIALS(PATH.join(this.context.homeBasePath, "credentials.json"));
}
...
PM.prototype.initForPackagePath = function(packagePath, parentPM) {
    ...
    return Q.call(function() {
        if (parentPM) {
            ...
            if (packagePath === self.context.program.package.path) {
                ...
                if (packageLocator) {
                    ...
                    if (typeof packageLocator === "string") {
                        ...
                        packagePath = resolvePackage(self.context.program.package.path, packageLocator);
                    } else {
                        throw new Error("NYI");
                    }
                }
